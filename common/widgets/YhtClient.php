...
//        "signerId"=>"1099893"
    ...
    /**
     * @param $type 0.token请求头  1.平台请求头(带token) 2.用户请求头(带token)
     * @param null $opt
     * @return array
     */
    ...
    public function sendReq($method=null, $url=null, $json=null){
        $json = [
        ...
        $reqHeader = $this->getReqOption(1, $json);
        return $this->client->request($method, YhtClient::$url['contract']['list'], $reqHeader);
    }
}
