                                        ...
                                        <div class="panel-body">
                                            ...
                                            <ul class="blocks-2 blocks-sm-3 mob-masonry" data-scale='1'>
                                                <?php foreach ($vrres as $v):?>
                                                    <li>
                                                        <a href="<?= Url::toRoute(['demo/goods','goods_id'=>$v['goods_id']])?>" target="_self" class="img" title="<?= $v['goods_name']?>">
                                                            <img class="swiper-lazy" data-src='<?= $v['goods_img']?>' alt="<?= $v['goods_name']?>">
                                                        </a>
                                                        <a href="<?= Url::toRoute(['demo/goods','goods_id'=>$v['goods_id']])?>" target="_self" class="txt" title="<?= $v['goods_name']?>"><?= mb_strrchr($v['goods_name'],'预',true)?></a>
                                                    </li>
                                                <?php endforeach;?>
                                            </ul>
                                        </div>
