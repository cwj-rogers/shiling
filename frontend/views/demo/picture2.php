...
-->
                            ...
                            <li class="product-li-first shown">
                                <h1>~ 网站建设 ~</h1>
                                <p>网站建设是指使用标识语言（markup language)，通过一系列设计、建模、和执行的过程将电子格式的信息通过互联网传输，最终以图形用户界面（GUI）的形式被用户所浏览。简单的信息如文字，图片（GIF，JPEG，PNG）和表格，都可以通过使超文件标示语言、可扩展超文本标记语言等标示语言放置到网站页面上。</p>
                                <span class="btn-default">
                                            <a class="click-box" title="网站建设" href="../picture/product.php?lang=cn&class2=112">
                                                <span>READ MORE</span>
                                            </a>
                                        </span>
                            </li>
...
-->
                            ...
                            <li class="product-li-first shown">
                                <h1>~ 平面设计 ~</h1>
                                <p>平面设计（graphic design），也称为视觉传达设计，是以“视觉”作为沟通和表现的方式，透过多种方式来创造和结合符号、图片和文字，借此作出用来传达想法或讯息的视觉表现。平面设计师可能会利用字体排印、视觉艺术、版面（page layout）、电脑软件等方面的专业技巧，来达成创作计划的目的。平面设计通常可指制作（设计）时的过程。</p>
                                <span class="btn-default">
                                            <a class="click-box" title="平面设计" href="../picture/product.php?lang=cn&class2=113">
                                                <span>READ MORE</span>
                                            </a>
                                        </span>
                            </li>
